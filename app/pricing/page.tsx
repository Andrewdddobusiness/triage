        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-6">
                ...
                <div className="bg-gray-100 text-xs font-medium text-gray-600 px-2 py-1 rounded inline-block mb-4">
                  Started Plan
                </div>
              ...
              <div className="border-t border-gray-100 p-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-sm">10 calls per month</span>
                  </li>
                  <li className="flex items-start">
                    <svg
                      className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0"
                    ...
                    <span className="text-sm">Limited AI follow-ups</span>
                  </li>
                  <li className="flex items-start">
                    <svg
                      className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden border-2 border-orange-500">
              <div className="p-6">
                ...
                <div className="bg-orange-100 text-xs font-medium text-orange-800 px-2 py-1 rounded inline-block mb-4">
                  Popular Plan
                </div>
                <p className="text-gray-600 text-sm mb-4">
              ...
              <div className="border-t border-gray-100 p-6">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start">
                    ...
                    <span className="text-sm">Complete call history</span>
                  </li>
                  <li className="flex items-start">
                    <svg
                      className="h-5 w-5 text-orange-500 mr-2 flex-shrink-0"
            ...
            <div className="bg-white rounded-lg shadow-sm overflow-hidden">
              <div className="p-6">
                ...
                <h2 className="text-xl font-bold mb-1">Elite</h2>
                <div className="bg-gray-100 text-xs font-medium text-gray-600 px-2 py-1 rounded inline-block mb-4">
                  Enterprise Plan
                </div>
                <p className="text-gray-600 text-sm mb-4">
          ...
          <div className="mt-20">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {/* <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-bold mb-2">What happens when I reach my call limit?</h3>
                <p className="text-gray-600 text-sm">
                  You'll receive a notification when you're approaching your limit. You can upgrade your plan or
              ...
              {/* <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="font-bold mb-2">Do you offer custom enterprise solutions?</h3>
                <p className="text-gray-600 text-sm">
                  Yes, for larger teams or specific requirements, contact us for a customized solution tailored to your
                  needs.
                </p>
              </div> */}
            </div>
